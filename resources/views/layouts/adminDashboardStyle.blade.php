  ...
  <body>
    <div class="page">
      ...
      <nav id="sidebar">
        ...
        </div><span class="text-uppercase text-gray-600 text-xs mx-3 px-2 heading mb-2">UMP Admin</span>
        <ul class="list-unstyled">
          <li class="sidebar-item {{Request::is('admin') ? 'active':''}} "><a class="sidebar-link" href="/admin"> 
            <svg class="svg-icon svg-icon-sm svg-icon-heavy">
              <use xlink:href="#real-estate-1"> </use>
            </svg><span>Dashboard </span></a></li>
          <li class="sidebar-item {{Request::is('ownerapprovalstatus') ? 'active':''}} "><a class="sidebar-link" href="/ownerapprovalstatus"> 
            <svg class="svg-icon svg-icon-sm svg-icon-heavy">
              <use xlink:href="#portfolio-grid-1"> </use>
            </svg><span>Owner Profile </span></a></li>
          <li class="sidebar-item {{Request::is('rentalhouserejection') ? 'active':''}} "><a class="sidebar-link" href="/rentalhouserejection"> 
            <svg class="svg-icon svg-icon-sm svg-icon-heavy">
              <use xlink:href="#sales-up-1"> </use>
            </svg><span>House Info</span></a></li>
          <li class="sidebar-item {{Request::is('userdata') ? 'active':''}} "><a class="sidebar-link" href="/userdata"> 
            <svg class="svg-icon svg-icon-sm svg-icon-heavy">
              <use xlink:href="#survey-1"> </use>
            </svg><span>User Role</span></a></li>
            <li class="sidebar-item {{Request::is('booking') ? 'active':''}} "><a class="sidebar-link" href="/booking"> 
              <svg class="svg-icon svg-icon-sm svg-icon-heavy">
                <use xlink:href="#survey-1"> </use>
