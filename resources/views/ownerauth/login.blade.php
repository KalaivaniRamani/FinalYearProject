...
<div class="row align-items-center justify-content-center">
    <div class="col-md-7">
    <h3 style="margin-bottom:45px;"><strong> Owner Login to UMP-HRMS</strong></h3>
    <!-- <p class="mb-4">Lorem ipsum dolor sit amet elit. Sapiente sit aut eos consectetur adipisicing.</p> -->
    <form method="post" action="{{ route('ownerauth.check') }}">
    @if (Session::get('fail'))
    ...
    <div class="row mb-8 px-3 text-center">
        <strong>
            <small class="font-weight-bold">Don't have an account?
                <a href="{{ route('ownerauth.register') }}" class="text-danger ">Register</a>
            </small>
        </strong>
    </div>
