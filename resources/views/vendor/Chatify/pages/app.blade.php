...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a><i href="#" class="fa fa-arrow-left" style="color:grey" onclick="history.back()"></i> <span class="messenger-headTitle" style="color:green">UMP-HRMS CHAT</span> </a>
                {{-- header buttons --}}
                <nav class="m-header-right">
                    <a href="#"><i class="fas fa-cog settings-btn" style="color:blue"></i></a>
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px; background-image: url('{{ Chatify::getUserWithAvatar(Auth::user())->picture }}');">
                    </div>
